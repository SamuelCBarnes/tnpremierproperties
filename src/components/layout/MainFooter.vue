<template>
<div class="mx-auto p-4 bg-footer-color text-[#737373]">
  <div class="md:flex justify-between items-center">
    <div class="mb-4 md:mb-0">Designed and built by <a class="hover:underline text-indigo-600" href="https://assimilationsoftware.com" target="_blank">Assimilation Software</a></div>

    <div class="flex justify-center">
      <div class="w-8 text-[#737373]">
      ...
      <div class="w-8 ml-2 text-[#737373]">
        <a href="#" class="hover:text-gray-700">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current">
